    ...
    pub const BLACK_KING_CASTLE_BOARD_MASK: u64 = (1 << 4) | (1 << 5) | (1 << 6) ;
    pub const BLACK_QUEEN_CASTLE_BOARD_MASK: u64 = (1 << 2) | (1 << 3) | (1 << 4);

    pub const WHITE_KING_CASTLE_BOARD_MASK: u64 = (1 << 60) | (1 << 61) | (1 << 62);
    pub const WHITE_QUEEN_CASTLE_BOARD_MASK: u64 = (1 << 58) | (1 << 59) | (1 << 60);
